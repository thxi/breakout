...
int main(void) {
  ...
  void (*cameraUpdaters[])(Camera2D *, Player *, EnvItem *, int, float, int,
                           int) = {
  ...
  char *cameraDescriptions[] = {
      ...
      "Follow player center horizontally; updateplayer center vertically after "
      "landing",
  ...
  while (!WindowShouldClose()) {
    ...
    Rectangle playerRect = {player.position.x - 20, player.position.y - 40, 40,
                            40};
